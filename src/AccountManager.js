...
class AccountManager extends EventTarget {
  ...
  requestVoiceVerification(captcha) {
    ...
    console.log(`AccountManager.requestVoiceVerification() - State of captcha: ${captcha}`);
  ...
  requestSMSVerification(captcha) {
    ...
    console.log(`AccountManager.requestSMSVerification() - State of captcha: ${captcha}`);
    ...
    return this.queueTask(() =>
      libsignal.KeyHelper.generateIdentityKeyPair().then(
        async identityKeyPair => {
          ...
          console.log(`AccountManager - User: ${this.username} - Pass: ${this.password}`);
